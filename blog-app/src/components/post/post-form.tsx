...
const postSchema = z.object({
    title: z.string().min(3, 'Title must be atleast 3 charaters long').max(255,
        'Title must be less than 255 charaters'
    ),
    description: z.string().min(5, 'Description must be atleast 5 charaters long').max(255,
        'Description must be less than 255 charaters'
    ),
    content: z.string().min(10, 'Content must be atleast 10 charaters long')
})
...
function PostForm({ isEditing, post }: PostFormProps) {
    ...
    return <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-6">
        ...
        <div className="space-y-2">
            ...
            <Textarea
                id="description"
                placeholder="Enter post description" {...register('description')}
        ...
        <div className="space-y-2">
            ...
            <Textarea
                id="content"
                placeholder="Enter post content" {...register('content')}
